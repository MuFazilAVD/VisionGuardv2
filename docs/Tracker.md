...
- Live `POST /api/claims/analyze` for `LIVE001`: returned one High risk assessment with four triggered indicators, 0.818291 final risk score, and deterministic fallback narrative metadata.
